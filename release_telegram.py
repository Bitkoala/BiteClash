...
CHAT_ID = os.getenv("TELEGRAM_CHAT_ID", "@BiteClash")
...
if IS_STABLE:
    text += f"\nhttps://github.com/Bitkoala/BiteClash/releases/tag/{TAG}\n"
else:
    text += f"\nhttps://github.com/Bitkoala/BiteClash/actions/runs/{RUN_ID}\n"
