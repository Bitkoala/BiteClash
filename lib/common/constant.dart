...
const appName = 'BiteClash';
const appHelperService = 'BiteClashHelperService';
const coreManifestName = 'manifest.json';
const coreName = 'clash.meta';
const browserUa =
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
const packageName = 'com.biteclash.app';
final unixSocketPath = '/tmp/BiteClashSocket_${Random().nextInt(10000)}.sock';
final windowsPipeName = '\\\\.\\pipe\\BiteClashCore_${_randomPipeId()}';
const helperPort = 47890;
const helperSocketPath = '/run/biteclash/helper.sock';
const helperProtocolVersionHeader = 'x-biteclash-helper-protocol';
...
const repository = 'Bitkoala/BiteClash';
...
const defaultPrimaryColor = 0xFF06B6D4;
...
const defaultPrimaryColors = [
  ...
  0xFF8B5CF6, // Electric Purple
  0xFF3B82F6, // Deep Sky Blue
  0xFF10B981, // Emerald Green
  0xFFF59E0B, // Cyber Amber
